...
All negative. That is plausible for a frame where every servo is mounted the same way
around, and it was confirmed against the RViz model before going to hardware.
...
```yaml
assembly_offsets:  [0.0307, 5.6941, 6.0792, 4.1924, 0.1672, 0.2163, 2.9683]
gripper_range_rad: [4.0298, 2.3761]   # [closed, open]
```

Gripper stroke is about 95°, close to Franka's own GELLO value of ~70°.
